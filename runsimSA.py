...
for i in range(numruns):
    sim = NewSimulator.from_file("gamestates/simple")
...
print('Average {} actions taken in average {} seconds with simple SA'.format(numactions/numruns, times/numruns))
...
print('Average {} actions taken in average {} seconds for SA with more anneal at same T'.format(numactionsMore/numruns, timesMore/numruns))
